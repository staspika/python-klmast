...
# Liste over mastetyper
master_list = [
    "B2", "B3", "B4", "B6", "H3", "H5", "H6", "HE200B", "HE220B",
    "HE240B", "HE260B", "HE280B", "HE260M"]
...
stromavtaker_1600 = {
    "Navn": "1600", "b_v": 0.746, "b_w": 0.800,
    "b_wc": 0.600, "alpha": 30}
stromavtaker_1800 = {
    "Navn": "1800", "b_v": 0.806, "b_w": 0.900,
    "b_wc": 0.731, "alpha": 40}
stromavtaker_1950 = {
    "Navn": "1950", "b_v": 0.954, "b_w": 0.975,
    "b_wc": 0.725, "alpha": 40}
...
# Liste over isklasser
isklasse_list = ["0   (0 N/m)",
                 "1   (3.5 N/m)",
                 "2   (7.5 N/m)",
                 "3   (15 N/m)"]
# Overhøyde D (= UE) avhengig av system
D_20B_35 = {
    "180": 0.150, "250": 0.150, "300": 0.150, "400": 0.140,
...
D_20A = {
    "180": 0.150, "250": 0.150, "300": 0.150, "400": 0.150,
...
D_25 = {
    ...
    "7000": 0.050, "10000": 0.035, "20000": 0.025, "10000000": 0.0}
# Sammenheng mellom kurveradie og sikksakkverdier for forskjellige systemer
sikksakk_20 = {
    "180": [-0.30, -0.30], "250": [-0.30, -0.30],
...
sidekraftbidrag_sno = [
    "Vindlast: Kontakttråd, økt diameter",
    "Vindlast: Bæreline, økt diameter",
    "Vindlast: Hengetråd, økt diameter",
    "Vindlast: Y-line, økt diameter"]
sidekraftbidrag_vind = [
    "Vindlast: Kontakttråd", "Vindlast: Bæreline",
    "Vindlast: Hengetråd", "Vindlast: Y-line"]
# Krefter som fjernes ved ulykkesberegning
ulykkeslaster_KL = [
    "Egenvekt: Bæreline", "Egenvekt: Hengetråd",
    "Egenvekt: Kontakttråd", "Egenvekt: Y-line", "Strekk: Bæreline",
    "Strekk: Kontakttråd", "Strekk: Bæreline til avspenning",
    "Strekk: Kontakttråd til avspenning",
    "Strekk: Torsjon, eksentrisitet utliggere",
    "Vandringskraft: Bæreline", "Vandringskraft: Kontakttråd",
    "Geometri: Ulik høyde mellom master"]


def hent_lastkombinasjoner(ec3):
    """Henter last- og kombinasjonsfaktorer til utregning av
    dimensjonerene laster.
    ...
    if ec3:
        ...
        lastsituasjoner = {
            "Temperatur dominerende": {
                "psi_T": 1.0, "psi_S": 0.7, "psi_V": 0.6, "T": -40},
            "Snølast dominerende": {
                "psi_T": 0.6, "psi_S": 1.0, "psi_V": 0.6, "T": 0},
            "Vind dominerende": {
                "psi_T": 0.6, "psi_S": 0.7, "psi_V": 1.0, "T": -25}}
        lastfaktorer = {
            "G": (1.2, 1.0), "L": (1.2, 1.0), "T": (1.5, 0),
            "S": (1.5, 0), "V": (1.5, 0)}
    else:
        # Lastsituasjoner og faktorer ihht. NEK (bransjestandard)
        lastsituasjoner = {
            "Maksimal temperaturlast": {
                "psi_T": 1.0, "psi_S": 0, "psi_V": 0, "T": -40},
            "Maksimal snølast": {
                "psi_T": 0, "psi_S": 1.0, "psi_V": 0, "T": 0},
            "Maksimal vindlast": {
                "psi_T": 0, "psi_S": 0, "psi_V": 1.0, "T": 5},
            "Kombinert vind- og snølast": {
                "psi_T": 0, "psi_S": 1.0, "psi_V": 0.5, "T": -25}}
        lastfaktorer = {
            "G": (1.3, 1.0), "L": (1.3, 1.0), "T": (1.3, 0),
            "S": (1.3, 0), "V": (1.3, 0)}
    return lastsituasjoner, lastfaktorer
